...
from app.api.middleware import AccessLogMiddleware, AuthMiddleware, RequestIDMiddleware
...
def create_app() -> FastAPI:
    ...
    # reads inside-out and yields the documented chain request-id → access log → auth/RBAC.
